/**
 * 7MARKET BUSINESS SCAN™ — canonical field list per step.
 * Mirrors apps/api/src/modules/business-scan/business-scan-schema.ts field-for-field
 * (same keys) — the API validates against its own copy; this one drives rendering.
...
export const INTEGRATION_LABELS: Record<IntegrationProvider, { pt: string; en: string }> = {
  erp: { pt: 'ERP', en: 'ERP' },
  crm: { pt: 'CRM', en: 'CRM' },
  contabilidade: { pt: 'Contabilidade', en: 'Accounting' },
  marketing: { pt: 'Marketing', en: 'Marketing' },
  open_banking: { pt: 'Open Banking', en: 'Open Banking' },
  google: { pt: 'Google', en: 'Google' },
  meta: { pt: 'Meta', en: 'Meta' },
  stripe: { pt: 'Stripe', en: 'Stripe' },
